...
static const DECLARE_TLV_DB_SCALE(softramp_rate, 0, 100, 0);
static const DECLARE_TLV_DB_SCALE(drc_target_tlv, -3200, 200, 0);
static const DECLARE_TLV_DB_SCALE(drc_recovery_tlv, -125, 250, 0);
...
static int es8326_resume(struct snd_soc_component *component)
{
	...
	regmap_write(es8326->regmap, ES8326_HPDET_TYPE, 0x99);
	...
	regmap_write(es8326->regmap, ES8326_PGAGAIN, 0x1a);
	regmap_write(es8326->regmap, ES8326_ADC_SCALE, 0x00);
	regmap_write(es8326->regmap, ES8326_DACL_VOL, 0xbf);
	...
	regmap_write(es8326->regmap,  ES8326_CLK_DIV1, 0xe0);
	regmap_write(es8326->regmap,  ES8326_CLK_DIV2, 0x00);
	regmap_write(es8326->regmap,  ES8326_CLK_DLL, 0x30);
	regmap_write(es8326->regmap,  ES8326_CLK_MUX, 0x2d);
	regmap_write(es8326->regmap,  ES8326_CLK_ADC_SEL, 0x4a);
	regmap_write(es8326->regmap,  ES8326_CLK_DAC_SEL, 0x0a);
